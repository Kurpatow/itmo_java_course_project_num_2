...
public class MainMenu extends BaseMenu {
    ...
    public void setStartNewGame(MenuCommand startNewGame) {
        if (startNewGame == null)
            throw new IllegalArgumentException("Значение команды startNewGame в MainMenu равно null");
        this.startNewGame = startNewGame;
    }

    public void setContinueGame(MenuCommand continueGame) {
        if (continueGame == null)
            throw new IllegalArgumentException("Значение команды continueGame в MainMenu равно null");
        this.continueGame = continueGame;
    }

    public void setLoadGame(MenuCommand loadGame) {
        if (loadGame == null)
            throw new IllegalArgumentException("Значение команды loadGame в MainMenu равно null");
        this.loadGame = loadGame;
    }

    public void setSaveGame(MenuCommand saveGame) {
        if (saveGame == null)
            throw new IllegalArgumentException("Значение команды saveGame в MainMenu равно null");
        this.saveGame = saveGame;
    }

    public void setExit(MenuCommand exit) {
        if (exit == null)
            throw new IllegalArgumentException("Значение команды exit в MainMenu равно null");
        this.exit = exit;
    }
